...
import { AiFillDelete, AiFillEdit, AiFillPauseCircle, AiOutlineDelete, AiOutlineEdit, AiOutlinePauseCircle } from 'react-icons/ai'
import { BsThreeDotsVertical } from 'react-icons/bs'

export default function ServiceCardOptions({ service }: { service: Service }) {
    const router = useRouter()
    const [toggleDeleteServiceModal, toggleServiceStatusModal] = useDashboardStore(state => [state.toggleDeleteServiceModal, state.toggleServiceStatusModal])
