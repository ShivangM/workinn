    ...
    return (
        <div className="flex flex-col max-w-lg p-6 rounded-lg shadow-md">
            <div className="relative aspect-square w-full mb-4 overflow-hidden">
                <Image src={images[0] || getImageFromUnsplash(name)} fill alt={name} className="object-cover" />
            </div>
            <div className="space-y-2 text-lg">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex text-base items-center space-x-2">
                        <div className={classNames("px-2 py-1 rounded-lg text-white", isPaused ? "bg-yellow-400" : "bg-green-400")}>
...
const SellerServices = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-8 p-6'>
            <Link target='_blank' rel='noreffer' href={'/manage-service'} className="flex items-center justify-center h-full bg-gray-100 border border-black p-4 min-h-[300px]">
